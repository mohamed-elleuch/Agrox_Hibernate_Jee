...
<div class="agileits_w3layouts_contact" id="contact">
	<div class="container"> 
		...
		PreparedStatement st=(PreparedStatement)con.prepareStatement("select * from capteur");
		ResultSet rs1=st.executeQuery();
		while(rs1.next())
		{
			String ch=rs1.getString("id");
			%>	
					...
					<br><br>
				<div class="col-md-12 col-xs-12 cont-editw3l" id="txt">
					Le graphe désiré va être affiché ici ..
					</div>
