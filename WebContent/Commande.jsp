...
<div class="agileits_w3layouts_contact" id="contact">
	<div class="container"> 
			<h3 class="agile-title">Commande Manuelle( Arrosage, Sys. Alarme ..)</h3>
		<div class="w3_mail_grids">
			<form action="Commande" method="post">
		<input type="text" id="eq" name="eq" />
					<div class="col-md-12 col-xs-12 cont-editw3l">
				<select onchange="document.getElementById('eq').value=this.options[this.selectedIndex].text">
					<option>Sélectionner un équipement</option>
					 <%
					 try
						{
		...
		PreparedStatement st=(PreparedStatement)con.prepareStatement("select * from equipement");
		ResultSet rs1=st.executeQuery();
		while(rs1.next())
		{
			String ch=rs1.getString("nom");
			%>	
					...
					<input type="submit" id="ok" name="ok" value="ON">
					<input type="submit" id="ok" name="ok" value="OFF">
				</div>
				<br><br>		
			</form>
	...
	<br><br>
		<div class="container"> 
		<div class="clearfix"></div>
			<h3 class="agile-title">Commande Automatique</h3>
		<div class="w3_mail_grids">
			<form action="#" method="post">
			
			<div class="col-md-12 col-xs-12 cont-editw3l">
				<select>
					<option>Sélectionner une plante</option>
					</select>
		...
		<div class="col-md-6 col-xs-6 cont-editw3l">
					...
					<input type="text" id="sminh" name="sminh" placeholder="Seuil Min Humidité" required=""/>
					
		</div>
		<div class="col-md-6 col-xs-6 cont-editw3l">
					
					<input type="text" id="smaxt" name="smaxt" placeholder="Seuil Max Température" required=""/>
					
		</div>
		<div class="col-md-12 col-xs-12 cont-editw3l">
					
					<input type="text" id="sminlum" name="sminlum" placeholder="Seuil Min Luminosité" required=""/>
