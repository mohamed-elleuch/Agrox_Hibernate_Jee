...
<div class="agileits_w3layouts_contact" id="contact">
	<div class="container"> 
		<h3 class="agile-title">Consommation Energitique</h3>
		...
		PreparedStatement st=(PreparedStatement)con.prepareStatement("select * from consommation");
		ResultSet rs1=st.executeQuery();
		while(rs1.next())
		{
			String ch=rs1.getString("nom_champ");
			String p=rs1.getString("nom_plante");
			String c=rs1.getString("nom_capteur");
			String a=rs1.getString("energie");
			%>	
						<tr>
					<td><%=ch %></td>
					<td><%=p %></td>
