...
<div class="agileits_w3layouts_contact" id="contact">
	<div class="container"> 
		<h3 class="agile-title">Ajout Nouveau Equipement</h3>
		<div class="w3_mail_grids">
			<form action="AjoutEq" method="post">
				<div class="col-md-6 col-xs-6 cont-editw3l">
					<input type="text" id="champ" name="champ" placeholder="Nom du champ du ferme" required=""/>
					<input type="text" id="ideq" name="ideq" placeholder="Id de l'équipement" required=""/>
				</div>
				<div class="col-md-6 col-xs-6 cont-editw3l">
					
					<input type="text" id="cat" name="cat" placeholder="Nom de l'équipement" required=""/>
					<input type="text" id="pin" name="pin" placeholder="Pin de l'équipement" required=""/>
				</div>
