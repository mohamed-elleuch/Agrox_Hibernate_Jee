...
<div class="agileits_w3layouts_contact" id="contact">
	<div class="container"> 
		<h3 class="agile-title">Liste des Alertes</h3>
		...
		PreparedStatement st=(PreparedStatement)con.prepareStatement("select * from alertes");
		ResultSet rs1=st.executeQuery();
		while(rs1.next())
		{
			String ch=rs1.getString("nomchamp");
			String p=rs1.getString("nomplante");
			String c=rs1.getString("nomcapteur");
			String a=rs1.getString("typealerte");
			String d=rs1.getString("date");
			String h=rs1.getString("heure");
			%>	
						<tr>
					<td><%=ch %></td>
					<td><%=p %></td>
