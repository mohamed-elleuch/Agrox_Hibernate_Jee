...
<div class="agileits_w3layouts_contact" id="contact">
	<div class="container"> 
		<h3 class="agile-title">Ajout Nouveau Capteur</h3>
		<div class="w3_mail_grids">
			<form action="AddCapteur" method="post">
				...
				<div class="col-md-6 col-xs-6 cont-editw3l">
					<input type="text" id="idcapteur" name="idcapteur" placeholder="Id du capteur" required=""/>
					<input type="text" id="ref" name="ref" placeholder="Libellé du capteur" required=""/>
				</div>
