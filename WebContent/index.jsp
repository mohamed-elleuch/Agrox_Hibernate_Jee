...
<div class="about w3layouts-agileinfo" id="about">
	<div class="container">
		<h3 class="agile-title">Bienvenue</h3>
		<div class="about-top w3ls-agile">
			...
			<div class="col-md-6 come">
				<div class="about-wel">
					<h2>A propos Agrox</h2>
					<p>Agrox est un système intelligent basé sur IOT (Internet des Objets) qui facilite la supervision des plantes côté humidité, température et luminosité en utilisant des capteurs sans fils qui s'adoptent à n'importe quel type de réseau existant par la technologie 6LOWPan émergée de la technologie ZigBEE.
					Ainsi que une partie importante correspondante à la commande des équipements de la ferme soit en utilisant le mode manuel soit en balayant vers le mode automatique paramétré par l'utilisateur.
					</p>
					<a href="index.html" class="w3l-logo"><i class="fa fa-pagelines" aria-hidden="true"></i>&nbsp;&nbsp;SOLUTION ADOPT AGROX:</a>
						<ul>
							<li><i class="fa fa-angle-double-right" aria-hidden="true"></i>Passerelle Raspberry Pi</li>
							<li><i class="fa fa-angle-double-right" aria-hidden="true"></i>Capteurs IOT TELOS Rev. B</li>
							<li><i class="fa fa-angle-double-right" aria-hidden="true"></i>Technologie ZigBee, 6LowPan</li>
							<li><i class="fa fa-angle-double-right" aria-hidden="true"></i>Cloud Ubidots Dashboard</li>
						</ul>
				</div>
			</div>
			<div class="clearfix"> </div>
